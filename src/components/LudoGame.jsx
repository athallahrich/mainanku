...
// ===== BOARD CONFIGURATION (Fallbacks & Built-in Defaults) =====
let OUTER_PATH = [
...
let STAR_POSITIONS = [1, 9, 14, 22, 27, 35, 40, 48];
    ...
    useEffect(() => {
        (async () => {
            try {
                ...
                console.error("Error loading Ludo game data, using fallbacks:", e);
                // IF fetch fails, initialize with fallback defaults
                setConfig({
                    dtQuestions: [],
                    userTruths: TRUTHS,
                    userDares: DARES
